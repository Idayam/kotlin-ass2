fun main() {
    var findLetters = findSort(arrayOf("mary","annet","idia","maureeen"))
    println(findLetters.contentToString())

}
fun findSort(words:Array<String>):Array<String>{
    var word=words.sortedArray()
    return word
...
//fun getLetter(str:List<String>):List<String>{
//    for (n in str){
//    }
//}
////1. Writse and invoke one function that takes in a random string and returns the
